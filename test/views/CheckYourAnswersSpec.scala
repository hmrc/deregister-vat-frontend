...
class CheckYourAnswersSpec extends ViewBaseSpec {
  ...
  "Rendering the Check your answers page" should {
    ...
    lazy val view = views.html.checkYourAnswers(checkYourAnswersModel)(user,messages,mockConfig)
    ...
    s"have the correct back text" in {
      ...
      element(Selectors.back).attr("href") shouldBe controllers.routes.DeregistrationDateController.show().url
    }
