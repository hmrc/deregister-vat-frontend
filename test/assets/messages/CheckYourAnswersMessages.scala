...
object CheckYourAnswersMessages {
  ...
  val taxableTurnover = "Taxable turnover in the last 12 months"
  val nextTaxableTurnover = "Expected taxable turnover for the next 12 months"
  val whyBelow = "Why will the turnover be below £83,000?"
  ...
  val optionTaxValue = "What was the total value of what the business charged?"
  val stocks = "Does the business have any stock to sell?"
