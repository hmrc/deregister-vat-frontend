...
object ContactPreferenceHttpParser {
  ...
  implicit object ContactPreferenceReads extends HttpReads[Either[ErrorModel, ContactPreference]] {

    override def read(method: String, url: String, response: HttpResponse): Either[ErrorModel, ContactPreference] = {
